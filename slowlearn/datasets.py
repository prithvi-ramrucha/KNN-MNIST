...
def load_MNIST():
    """This method loads the MNIST dataset and returns it as a dataset object. The files must be in the CWD of the main script."""

    # Loading data as NumPy arrays,
    X, y = np.load("MNIST-X.npy"), np.load("MNIST-y.npy")
